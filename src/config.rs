...
fn auth_mechanism<D>(deserializer: D) -> ::std::result::Result<Option<authentication::Mechanism>, D::Error> where D: Deserializer {
...
"#;
		...
		assert_eq!(smtp.auth_mechanism.unwrap(), authentication::Mechanism::CramMd5);
